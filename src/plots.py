...
from numpy import arange, array, delete, append
...
class Plots:
    ...
    def get_time_bins(self, evts_per_bin=None):
        ...
        return [self.NBins, self.TimeBinning]

    def get_event_bins(self, binning=None):
        self.set_bin_size(binning)
        return [self.NBins, array(self.Binning, 'd')]
    ...
    def get_binning(self, evts_per_bin=None):
        ...
        events = arange(min(self.Cut.get_min_event(), jumps[0][1]), self.Cut.get_max_event())
