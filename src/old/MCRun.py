...
class MCRun(Run):
    ...
    def __init__(self, run_number=None, verbose=False):
        Run.__init__(self, number=run_number, verbose=verbose)
        self.MCAttributes = {
            'NPeaks': None,
            'PeakHeight': 0.5,
            'PeakSigmaX_min': 0.02,
    ...
    def LoadMCConfig(self):
        ...
        assert (SpecialDistribution in ["No", "False", "4Peaks", "4peaks", "Central", "central", "L", "3Peaks", "Testpattern", "testpattern", "Test",
                                        "test"]), "Bad MC Config file. SpecialDistribution: " + SpecialDistribution + " in SIGNAL-DSITRIBUTION unknown"
